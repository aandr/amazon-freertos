...
/* Name of the thing. */
#define renesasDemoTHING_NAME                 clientcredentialIOT_THING_NAME
...
static void prvUpdateQueueTask( void * pvParameters )
{
    ...
    xUpdateParams.pcThingName = renesasDemoTHING_NAME;
...
static void prvShadowInitTask( void * pvParameters )
{
    ...
    if( xReturn == eShadowSuccess )
    {
        xOperationParams.pcThingName = renesasDemoTHING_NAME;
        ...
        if( ( xReturn == eShadowSuccess ) || ( xReturn == eShadowRejectedNotFound ) )
        {
             ...
             * delta callback.*/
            xCallbackParams.pcThingName = renesasDemoTHING_NAME;
