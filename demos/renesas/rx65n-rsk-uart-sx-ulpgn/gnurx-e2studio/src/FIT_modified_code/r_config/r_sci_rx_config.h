...
#define SCI_CFG_CH2_TX_BUFSIZ   (1000)
#define SCI_CFG_CH3_TX_BUFSIZ   (80)
#define SCI_CFG_CH4_TX_BUFSIZ   (80)
#define SCI_CFG_CH5_TX_BUFSIZ   (1500)
#define SCI_CFG_CH6_TX_BUFSIZ   (1460)
